...
public class FavoriteUsersProvider extends ContentProvider {
    private static final int CODE_USER = 1;
    private static final String AUTHORITY = "com.example.submision2fundamental.provider";
    ...
    public boolean onCreate() {
        userDAO = Room.databaseBuilder(Objects.requireNonNull(getContext()), DatabaseApp.class, DB_NAME)
                .build()
                .userDAO();
        return true;
    }
