...
import com.example.submision3fundamental.views.fragment.FollowFragment;
...
public class DetailActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener {
    ...
    ViewPager viewPager;
    @BindView(R.id.kotak_desk)
    AppBarLayout appBarLayout;
    @BindView(R.id.foto_user) ImageView avatar;
    ...
    @BindView(R.id.tvRepository) TextView repository;
        ...
        client.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    if (responseObject.getString("repository").equals("null")) repository.setVisibility(View.GONE);
                    else repository.setText(responseObject.getString("repository"));
